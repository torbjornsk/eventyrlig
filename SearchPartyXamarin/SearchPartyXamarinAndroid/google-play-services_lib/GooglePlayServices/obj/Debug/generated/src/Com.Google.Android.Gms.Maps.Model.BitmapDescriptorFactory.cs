...
namespace Com.Google.Android.Gms.Maps.Model {
	...
	public sealed partial class BitmapDescriptorFactory : global::Java.Lang.Object {
		...
		public static global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor DefaultMarker ()
		{
			...
			return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor> (JNIEnv.CallStaticObjectMethod  (class_ref, id_defaultMarker), JniHandleOwnership.TransferLocalRef);
		}

		static IntPtr id_defaultMarker_F;
		[Register ("defaultMarker", "(F)Lcom/google/android/gms/maps/model/BitmapDescriptor;", "")]
		public static global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor DefaultMarker (float p0)
		{
			...
			return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor> (JNIEnv.CallStaticObjectMethod  (class_ref, id_defaultMarker_F, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
		}
		...
		public static global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor FromAsset (string p0)
		{
			...
			global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor __ret = global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor> (JNIEnv.CallStaticObjectMethod  (class_ref, id_fromAsset_Ljava_lang_String_, new JValue (native_p0)), JniHandleOwnership.TransferLocalRef);
		...
		public static global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor FromBitmap (global::Android.Graphics.Bitmap p0)
		{
			...
			global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor __ret = global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor> (JNIEnv.CallStaticObjectMethod  (class_ref, id_fromBitmap_Landroid_graphics_Bitmap_, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
			return __ret;
		}
		...
		public static global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor FromFile (string p0)
		{
			...
			IntPtr native_p0 = JNIEnv.NewString (p0);
			global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor __ret = global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor> (JNIEnv.CallStaticObjectMethod  (class_ref, id_fromFile_Ljava_lang_String_, new JValue (native_p0)), JniHandleOwnership.TransferLocalRef);
			JNIEnv.DeleteLocalRef (native_p0);
			return __ret;
		}
		...
		public static global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor FromPath (string p0)
		{
			...
			IntPtr native_p0 = JNIEnv.NewString (p0);
			global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor __ret = global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor> (JNIEnv.CallStaticObjectMethod  (class_ref, id_fromPath_Ljava_lang_String_, new JValue (native_p0)), JniHandleOwnership.TransferLocalRef);
			JNIEnv.DeleteLocalRef (native_p0);
			return __ret;
		}
		...
		public static global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor FromResource (int p0)
		{
			...
			return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.BitmapDescriptor> (JNIEnv.CallStaticObjectMethod  (class_ref, id_fromResource_I, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
		}
