...
namespace Com.Google.Android.Gms.Maps {
	...
	public partial class MapView : global::Android.Widget.FrameLayout {
		...
		public MapView (global::Android.Content.Context p0, global::Com.Google.Android.Gms.Maps.GoogleMapOptions p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
