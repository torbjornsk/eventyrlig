...
namespace Com.Google.Android.Gms.Maps {
	...
	public partial class SupportMapFragment : global::Android.Support.V4.App.Fragment {
		...
		public global::Com.Google.Android.Gms.Maps.GoogleMap Map {
			...
			get {
				...
				return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.GoogleMap> (JNIEnv.CallObjectMethod  (Handle, id_getMap), JniHandleOwnership.TransferLocalRef);
			}
		}

		static IntPtr id_newInstance;
		[Register ("newInstance", "()Lcom/google/android/gms/maps/SupportMapFragment;", "")]
		public static global::Com.Google.Android.Gms.Maps.SupportMapFragment NewInstance ()
		{
			...
			return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.SupportMapFragment> (JNIEnv.CallStaticObjectMethod  (class_ref, id_newInstance), JniHandleOwnership.TransferLocalRef);
		}
		...
		public static global::Com.Google.Android.Gms.Maps.SupportMapFragment NewInstance (global::Com.Google.Android.Gms.Maps.GoogleMapOptions p0)
		{
			...
			global::Com.Google.Android.Gms.Maps.SupportMapFragment __ret = global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.SupportMapFragment> (JNIEnv.CallStaticObjectMethod  (class_ref, id_newInstance_Lcom_google_android_gms_maps_GoogleMapOptions_, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
			return __ret;
		}
