...
namespace Com.Google.Android.Gms.Maps.Model {
	...
	public sealed partial class CameraPosition : global::Java.Lang.Object {
		...
		[Register ("CREATOR")]
		public static global::Com.Google.Android.Gms.Maps.Model.CameraPositionCreator Creator {
			get {
				if (CREATOR_jfieldId == IntPtr.Zero)
					CREATOR_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "CREATOR", "Lcom/google/android/gms/maps/model/CameraPositionCreator;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, CREATOR_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.CameraPositionCreator> (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (CREATOR_jfieldId == IntPtr.Zero)
					CREATOR_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "CREATOR", "Lcom/google/android/gms/maps/model/CameraPositionCreator;");
		...
		[Register ("target")]
		public global::Com.Google.Android.Gms.Maps.Model.LatLng Target {
			get {
				...
				return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.LatLng> (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (target_jfieldId == IntPtr.Zero)
					target_jfieldId = JNIEnv.GetFieldID (class_ref, "target", "Lcom/google/android/gms/maps/model/LatLng;");
		...
		public sealed partial class Builder : global::Java.Lang.Object {
			...
			public Builder (global::Com.Google.Android.Gms.Maps.Model.CameraPosition p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (Handle != IntPtr.Zero)
					return;
			...
			public global::Com.Google.Android.Gms.Maps.Model.CameraPosition.Builder Bearing (float p0)
			{
				...
				return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.CameraPosition.Builder> (JNIEnv.CallObjectMethod  (Handle, id_bearing_F, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
			}

			static IntPtr id_build;
			[Register ("build", "()Lcom/google/android/gms/maps/model/CameraPosition;", "")]
			public global::Com.Google.Android.Gms.Maps.Model.CameraPosition Build ()
			{
				if (id_build == IntPtr.Zero)
					id_build = JNIEnv.GetMethodID (class_ref, "build", "()Lcom/google/android/gms/maps/model/CameraPosition;");
				return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.CameraPosition> (JNIEnv.CallObjectMethod  (Handle, id_build), JniHandleOwnership.TransferLocalRef);
			}
			...
			public global::Com.Google.Android.Gms.Maps.Model.CameraPosition.Builder Target (global::Com.Google.Android.Gms.Maps.Model.LatLng p0)
			{
				...
				global::Com.Google.Android.Gms.Maps.Model.CameraPosition.Builder __ret = global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.CameraPosition.Builder> (JNIEnv.CallObjectMethod  (Handle, id_target_Lcom_google_android_gms_maps_model_LatLng_, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
				return __ret;
			}

			static IntPtr id_tilt_F;
			[Register ("tilt", "(F)Lcom/google/android/gms/maps/model/CameraPosition$Builder;", "")]
			public global::Com.Google.Android.Gms.Maps.Model.CameraPosition.Builder Tilt (float p0)
			{
				...
				return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.CameraPosition.Builder> (JNIEnv.CallObjectMethod  (Handle, id_tilt_F, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
			}

			static IntPtr id_zoom_F;
			[Register ("zoom", "(F)Lcom/google/android/gms/maps/model/CameraPosition$Builder;", "")]
			public global::Com.Google.Android.Gms.Maps.Model.CameraPosition.Builder Zoom (float p0)
			{
				...
				return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.CameraPosition.Builder> (JNIEnv.CallObjectMethod  (Handle, id_zoom_F, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
			}
		...
		public CameraPosition (global::Com.Google.Android.Gms.Maps.Model.LatLng p0, float p1, float p2, float p3) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		public static global::Com.Google.Android.Gms.Maps.Model.CameraPosition.Builder InvokeBuilder ()
		{
			...
			return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.CameraPosition.Builder> (JNIEnv.CallStaticObjectMethod  (class_ref, id_builder), JniHandleOwnership.TransferLocalRef);
		}
		...
		public static global::Com.Google.Android.Gms.Maps.Model.CameraPosition.Builder InvokeBuilder (global::Com.Google.Android.Gms.Maps.Model.CameraPosition p0)
		{
			...
			global::Com.Google.Android.Gms.Maps.Model.CameraPosition.Builder __ret = global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.CameraPosition.Builder> (JNIEnv.CallStaticObjectMethod  (class_ref, id_builder_Lcom_google_android_gms_maps_model_CameraPosition_, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
			return __ret;
		}
		...
		public static global::Com.Google.Android.Gms.Maps.Model.CameraPosition CreateFromAttributes (global::Android.Content.Context p0, global::Android.Util.IAttributeSet p1)
		{
			...
			global::Com.Google.Android.Gms.Maps.Model.CameraPosition __ret = global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.CameraPosition> (JNIEnv.CallStaticObjectMethod  (class_ref, id_createFromAttributes_Landroid_content_Context_Landroid_util_AttributeSet_, new JValue (p0), new JValue (p1)), JniHandleOwnership.TransferLocalRef);
			return __ret;
		}
		...
		public static global::Com.Google.Android.Gms.Maps.Model.CameraPosition FromLatLngZoom (global::Com.Google.Android.Gms.Maps.Model.LatLng p0, float p1)
		{
			...
			global::Com.Google.Android.Gms.Maps.Model.CameraPosition __ret = global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.CameraPosition> (JNIEnv.CallStaticObjectMethod  (class_ref, id_fromLatLngZoom_Lcom_google_android_gms_maps_model_LatLng_F, new JValue (p0), new JValue (p1)), JniHandleOwnership.TransferLocalRef);
			return __ret;
		}
