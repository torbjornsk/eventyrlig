...
namespace Com.Google.Android.Gms.Maps.Model {
	...
	public sealed partial class LatLngBounds : global::Java.Lang.Object {
		...
		[Register ("CREATOR")]
		public static global::Com.Google.Android.Gms.Maps.Model.LatLngBoundsCreator Creator {
			get {
				if (CREATOR_jfieldId == IntPtr.Zero)
					CREATOR_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "CREATOR", "Lcom/google/android/gms/maps/model/LatLngBoundsCreator;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, CREATOR_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.LatLngBoundsCreator> (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (CREATOR_jfieldId == IntPtr.Zero)
					CREATOR_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "CREATOR", "Lcom/google/android/gms/maps/model/LatLngBoundsCreator;");
		...
		[Register ("northeast")]
		public global::Com.Google.Android.Gms.Maps.Model.LatLng Northeast {
			get {
		...
		[Register ("southwest")]
		public global::Com.Google.Android.Gms.Maps.Model.LatLng Southwest {
			get {
		...
		public sealed partial class Builder : global::Java.Lang.Object {
			...
			public global::Com.Google.Android.Gms.Maps.Model.LatLngBounds Build ()
			{
				if (id_build == IntPtr.Zero)
					id_build = JNIEnv.GetMethodID (class_ref, "build", "()Lcom/google/android/gms/maps/model/LatLngBounds;");
				return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.LatLngBounds> (JNIEnv.CallObjectMethod  (Handle, id_build), JniHandleOwnership.TransferLocalRef);
			}
			...
			public global::Com.Google.Android.Gms.Maps.Model.LatLngBounds.Builder Include (global::Com.Google.Android.Gms.Maps.Model.LatLng p0)
			{
				...
				global::Com.Google.Android.Gms.Maps.Model.LatLngBounds.Builder __ret = global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.LatLngBounds.Builder> (JNIEnv.CallObjectMethod  (Handle, id_include_Lcom_google_android_gms_maps_model_LatLng_, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
				return __ret;
			}
		...
		public LatLngBounds (global::Com.Google.Android.Gms.Maps.Model.LatLng p0, global::Com.Google.Android.Gms.Maps.Model.LatLng p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		public static global::Com.Google.Android.Gms.Maps.Model.LatLngBounds.Builder InvokeBuilder ()
		{
			...
			return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.LatLngBounds.Builder> (JNIEnv.CallStaticObjectMethod  (class_ref, id_builder), JniHandleOwnership.TransferLocalRef);
		}
		...
		public bool Contains (global::Com.Google.Android.Gms.Maps.Model.LatLng p0)
		{
		...
		public global::Com.Google.Android.Gms.Maps.Model.LatLngBounds Including (global::Com.Google.Android.Gms.Maps.Model.LatLng p0)
		{
			...
			global::Com.Google.Android.Gms.Maps.Model.LatLngBounds __ret = global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.LatLngBounds> (JNIEnv.CallObjectMethod  (Handle, id_including_Lcom_google_android_gms_maps_model_LatLng_, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
			return __ret;
		}
