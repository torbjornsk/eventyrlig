...
namespace Com.Google.Android.Gms.Maps.Model {
	...
	public abstract class TileProvider {
		...
		[Register ("NO_TILE")]
		public static global::Com.Google.Android.Gms.Maps.Model.Tile NoTile {
			get {
				...
				return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.Tile> (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (NO_TILE_jfieldId == IntPtr.Zero)
					NO_TILE_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "NO_TILE", "Lcom/google/android/gms/maps/model/Tile;");
	...
	[Register ("com/google/android/gms/maps/model/TileProvider", "", "Com.Google.Android.Gms.Maps.Model.ITileProviderInvoker")]
	public partial interface ITileProvider : IJavaObject {

		[Register ("getTile", "(III)Lcom/google/android/gms/maps/model/Tile;", "GetGetTile_IIIHandler:Com.Google.Android.Gms.Maps.Model.ITileProviderInvoker, GooglePlayServices")]
		global::Com.Google.Android.Gms.Maps.Model.Tile GetTile (int p0, int p1, int p2);
...
#pragma warning disable 0169
		...
		{
			global::Com.Google.Android.Gms.Maps.Model.ITileProvider __this = global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.ITileProvider> (native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.GetTile (p0, p1, p2));
		}
#pragma warning restore 0169

		IntPtr id_getTile_III;
		public global::Com.Google.Android.Gms.Maps.Model.Tile GetTile (int p0, int p1, int p2)
		{
			...
			return global::Java.Lang.Object.GetObject<global::Com.Google.Android.Gms.Maps.Model.Tile> (JNIEnv.CallObjectMethod (Handle, id_getTile_III, new JValue (p0), new JValue (p1), new JValue (p2)), JniHandleOwnership.TransferLocalRef);
		}
