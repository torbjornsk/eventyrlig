...
namespace Com.Google.Android.Gms.Maps.Model {
	...
	public sealed partial class Polyline : global::Java.Lang.Object {
		...
		static IntPtr id_ctor_Lcom_google_android_gms_maps_model_internal_IPolylineDelegate_;
		[Register (".ctor", "(Lcom/google/android/gms/maps/model/internal/IPolylineDelegate;)V", "")]
		public Polyline (global::Com.Google.Android.Gms.Maps.Model.Internal.IPolylineDelegate p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (Polyline)) {
				SetHandle (global::Android.Runtime.JNIEnv.CreateInstance (GetType (), "(Lcom/google/android/gms/maps/model/internal/IPolylineDelegate;)V", new JValue (p0)), JniHandleOwnership.TransferLocalRef);
				return;
			}

			if (id_ctor_Lcom_google_android_gms_maps_model_internal_IPolylineDelegate_ == IntPtr.Zero)
				id_ctor_Lcom_google_android_gms_maps_model_internal_IPolylineDelegate_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lcom/google/android/gms/maps/model/internal/IPolylineDelegate;)V");
			SetHandle (JNIEnv.NewObject (class_ref, id_ctor_Lcom_google_android_gms_maps_model_internal_IPolylineDelegate_, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
		}
